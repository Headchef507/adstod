...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<c:url value="/src/main/resources/static/css/postitnote.css"/>"/>
    </head>
    <body>
            ...
            <table class="notes">
                ...
                <%--c:forEach var="questionText" items="${questions}">
                    <tr>
                        ...
                        <td><a href="/questions/${questionText.questionText}">${questionText.questionText}</a></td>
